...
describe('Project01 - Validate Form Elements', () => {
  ...
  beforeEach(() => { 
    ...
    it('Test Case 10 - Validate the Form Submission', () => {
      ...
      const fname = "Ali";
      const address = "17234 Betland dr. Tinley Park IL 60487";
      const email = "aliyadabel@gmail.com";
      const phone = "345 678 34 88";
      const message = "I would like to get better at cypress"
